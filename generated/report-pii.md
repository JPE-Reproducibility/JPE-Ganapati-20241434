...
|-----------|------|----------------------|----------------|
| Data | `AUS_cleaned.csv` | 1 | country |
| Data | `COL_EXP_2012.dta` | 2 | country |
| Data | `CYD_manuf.dta` | 1 | country |
| Data | `CYH2D_manuf.dta` | 2 | country |
| Data | `CYH2D_manuf_1000usd.dta` | 2 | country |
| Data | `CY_manuf.dta` | 1 | country |
...
| Data | `SSIS_BSC_ISIC4_11042019175351230.csv` | 2 | loc, location, country |
| Data | `Simulated_data_LogNormal_alt.mat` | 2 | lon |
| Data | `TES3_04052018220827756.csv` | 2 | country |
| Data | `WIOT2000_October16_ROW.dta` | 1 | country |
| Data | `WIOT2001_October16_ROW.dta` | 1 | country |
| Data | `WIOT2002_October16_ROW.dta` | 1 | country |
| Data | `WIOT2003_October16_ROW.dta` | 1 | country |
| Data | `WIOT2004_October16_ROW.dta` | 1 | country |
| Data | `WIOT2005_October16_ROW.dta` | 1 | country |
| Data | `WIOT2006_October16_ROW.dta` | 1 | country |
| Data | `WIOT2007_October16_ROW.dta` | 1 | country |
| Data | `WIOT2008_October16_ROW.dta` | 1 | country |
| Data | `WIOT2009_October16_ROW.dta` | 1 | country |
| Data | `WIOT2010_October16_ROW.dta` | 1 | country |
| Data | `WIOT2011_October16_ROW.dta` | 1 | country |
| Data | `WIOT2012_October16_ROW.dta` | 1 | country |
| Data | `WIOT2013_October16_ROW.dta` | 1 | country |
| Data | `WIOT2014_October16_ROW.dta` | 1 | country |
...
| Data | `exports_2010.dta` | 1 | country |
| Data | `exports_2011.dta` | 1 | country |
| Data | `exports_2012.dta` | 1 | country |
| Data | `fpart_concordance.dta` | 1 | country |
| Data | `geo_cepii.dta` | 25 | country, name, loc, city, lat, degree, lon, son |
| Data | `geo_cepii.xls` | 15 | country, loc, city, lat, lon |
...
| Code | `Figure_Sequencer.m` | 5 | city, lon |
...
| Code | `GMM_gravity.m` | 5 | lon, second |
...
| Code | `Script_GMM_simulation.m` | 28 | lat, lon, loc, name, second |
| Code | `Script_QQ_simulation.m` | 27 | lat, lon, loc, name, second, city |
| Code | `Simulation_Data_v10.m` | 51 | lat, city, lon, loc, location, name |
| Code | `Test_Code.m` | 2 | lon |
| Code | `create_elasticity_functions.m` | 19 | city, lon, lat, son |
| Code | `figure_plotter_QQ_minimal.m` | 9 | lat, degree, name |
| Code | `figures_gen.m` | 41 | city, lat, son, name, loc, location, child, dob |
| Code | `function_interp_wrapper.m` | 9 | lon, city, lat, son |
| Code | `function_interp_wrapper_GMM.m` | 8 | lon, city |
| Code | `generate_QQ_plot.m` | 19 | lat |
| Code | `generate_eps.m` | 1 | lon |
| Code | `generate_pdf_entry.m` | 5 | lat, name, loc, location |
| Code | `get_fct_form_params.m` | 4 | city |
| Code | `graph_overlay.m` | 31 | lon, lat, loc, location, city, name |
| Code | `hs_routine_gravity.m` | 8 | lon, city |
...
| Code | `p02_ChinaData_Morrow.do` | 3 | loc, country, name |
...
| Code | `plot_Er_vs_log_n.m` | 3 | name, lon, loc, location |
| Code | `plot_logcorr_pareto.m` | 1 | lon |
| Code | `plot_theta_c_vs_log_n.m` | 2 | name, loc, location |
| Code | `plot_theta_combined.m` | 6 | lon, name, loc, location |
| Code | `plot_theta_e_vs_log_n.m` | 9 | lon, lat, name, loc, location |
| Code | `plot_theta_i_vs_log_n.m` | 6 | lon, name, loc, location |
| Code | `recover_elasticities_LN.m` | 6 | lon, lat |
| Code | `regQQ.m` | 4 | lon, lat |
| Code | `run_mc_master.m` | 34 | lat, city, lon, name |
| Code | `solve_FP.m` | 19 | lat, city, lon, country, name |
| Code | `vline.m` | 2 | loc, location, lat |
| Code | `vline.m` | 2 | loc, location, lat |
