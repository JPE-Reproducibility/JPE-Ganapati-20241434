function plot_theta_i_vs_log_n(alpha_c, alpha_e, e_bar, n_min, n_max, num_points)
...
%     title(sprintf('θ^{i}(n) vs log(n): α^c = %.2f, α^e = %.2f, ē = %.2f', ...
