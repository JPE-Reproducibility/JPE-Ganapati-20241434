%% Wrapper to Plot Aggregate Data
    ...
    c  = scatter(xmetric(all),ymetric2(all),[],'black','o');
    hold off
    legend([c a b ],{'Constant Elasticity - All Countries' 'Semiparametric - Developed', 'Semiparametric - Developing' },'FontSize',14,'Location','northeast')
    f = gcf;
